...
const routes = [
  ...
  },
  {
    ...
    children: (pre => [
      ...
      { path: 'data-table', name: `${pre}data-table`, component: () => import('@/pages/demo/element/data-table/index.vue'), meta },
      { path: 'data-tag', name: `${pre}data-tag`, component: () => import('@/pages/demo/element/data-tag/index.vue'), meta },
      { path: 'data-progress', name: `${pre}data-progress`, component: () => import('@/pages/demo/element/data-progress/index.vue'), meta },
      { path: 'data-tree', name: `${pre}data-tree`, component: () => import('@/pages/demo/element/data-tree/index.vue'), meta },
      { path: 'data-pagination', name: `${pre}data-pagination`, component: () => import('@/pages/demo/element/data-pagination/index.vue'), meta },
      { path: 'data-badge', name: `${pre}data-badge`, component: () => import('@/pages/demo/element/data-badge/index.vue'), meta },
      { path: 'notice-alert', name: `${pre}notice-alert`, component: () => import('@/pages/demo/element/notice-alert/index.vue'), meta },
      { path: 'notice-loading', name: `${pre}notice-loading`, component: () => import('@/pages/demo/element/notice-loading/index.vue'), meta },
      { path: 'notice-message', name: `${pre}notice-message`, component: () => import('@/pages/demo/element/notice-message/index.vue'), meta },
      { path: 'notice-message-box', name: `${pre}notice-message-box`, component: () => import('@/pages/demo/element/notice-message-box/index.vue'), meta },
      { path: 'notice-notification', name: `${pre}notice-notification`, component: () => import('@/pages/demo/element/notice-notification/index.vue'), meta },
      { path: 'navigation-menu', name: `${pre}navigation-menu`, component: () => import('@/pages/demo/element/navigation-menu/index.vue'), meta },
      { path: 'navigation-tabs', name: `${pre}navigation-tabs`, component: () => import('@/pages/demo/element/navigation-tabs/index.vue'), meta },
      { path: 'navigation-breadcrumb', name: `${pre}navigation-breadcrumb`, component: () => import('@/pages/demo/element/navigation-breadcrumb/index.vue'), meta },
      { path: 'navigation-dropdown', name: `${pre}navigation-dropdown`, component: () => import('@/pages/demo/element/navigation-dropdown/index.vue'), meta },
      { path: 'navigation-steps', name: `${pre}navigation-steps`, component: () => import('@/pages/demo/element/navigation-steps/index.vue'), meta },
