...
const frameIn = [
  ...
  },
  {
    ...
    children: (pre => [
      ...
      { path: 'db/page-public', name: `${pre}db-page-public`, component: () => import('@/pages/demo/playground/db/page-public'), meta: { ...meta, title: '页面存储' } },
      { path: 'db/page-user', name: `${pre}db-page-user`, component: () => import('@/pages/demo/playground/db/page-user'), meta: { ...meta, title: '页面存储 用户' } },
      { path: 'db/page-snapshot-public', name: `${pre}db-page-snapshot-public`, component: () => import('@/pages/demo/playground/db/page-snapshot-public'), meta: { ...meta, title: '页面快照' } },
      { path: 'db/page-snapshot-user', name: `${pre}db-page-snapshot-user`, component: () => import('@/pages/demo/playground/db/page-snapshot-user'), meta: { ...meta, title: '页面快照 用户' } },
